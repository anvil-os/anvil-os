...
TEST(stdio_printf, fmt_f)
{
    ...
    static const struct test_point test_vector[] =
    {
        { "123.0",  1, "%f", 123.0 },
        { "-123.0",  1, "%f", -123.0 },
        ...
        { "1e-6",  1, "%f", 1e-6 },
        { "123.456e-100",  1, "%f", 123.456e-100 },
        { "123.456e200",  1, "%f", 123.456e200 },
        { "1.555555",  1, "%f", 1.555555 },
        { "1.5555554",  1, "%f", 1.5555554 },
        { "1.5555555",  1, "%f", 1.5555555 },
        { "1.0",  1, "%f", 1.0 },
        { "0.1",  1, "%f", 0.1 },
        { "0.01",  1, "%f", 0.01 },
        { "123.0",  1, "%e", 123.0 },
        { "-123.0",  1, "%e", -123.0 },
        { "9999999999.0",  1, "%e", 9999999999.0 },
        { "12345.6789",  1, "%e", 12345.6789 },
        { "99999.99999",  1, "%e", 99999.99999 },
        { "100000.00000",  1, "%e", 100000.00000 },
        { "100000.00001",  1, "%e", 100000.00001 },
        { "1e-6",  1, "%e", 1e-6 },
        { "123.456e-100",  1, "%e", 123.456e-100 },
        { "123.456e200",  1, "%e", 123.456e200 },
        { "1.555555",  1, "%e", 1.555555 },
        { "1.5555554",  1, "%e", 1.5555554 },
        { "1.5555555",  1, "%e", 1.5555555 },
        { "1.0",  1, "%e", 1.0 },
        { "0.1",  1, "%e", 0.1 },
        { "0.01",  1, "%e", 0.01 },
        { "1234.5678",  1, "%.16e", 1234.5678 },
        { "1234.5678",  1, "%.17e", 1234.5678 },
        { "1234.5678",  1, "%.18e", 1234.5678 },
        { "1234.5678",  1, "%.30e", 1234.5678 },
